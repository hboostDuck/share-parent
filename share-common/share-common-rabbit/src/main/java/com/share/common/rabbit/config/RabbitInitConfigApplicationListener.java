...
import com.share.common.rabbit.entity.ShareCorrelationData;
...
public class RabbitInitConfigApplicationListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private void setupCallbacks() {
        ...
        this.rabbitTemplate.setReturnsCallback(returned -> {
            ...
            ShareCorrelationData correlationData = JSON.parseObject(correlationDataStr, ShareCorrelationData.class);
            //2.调用消息重发方法
    ...
    private void retrySendMsg(CorrelationData correlationData) {
        //获取相关数据
        ShareCorrelationData gmallCorrelationData = (ShareCorrelationData) correlationData;
