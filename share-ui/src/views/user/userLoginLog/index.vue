    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['user:userLoginLog:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['user:userLoginLog:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['user:userLoginLog:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['user:userLoginLog:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="userLoginLogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['user:userLoginLog:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['user:userLoginLog:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listUserLoginLog, getUserLoginLog, delUserLoginLog, addUserLoginLog, updateUserLoginLog } from "@/api/user/userLoginLog";
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除用户登录记录编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('user/userLoginLog/export', {
    ...queryParams.value
